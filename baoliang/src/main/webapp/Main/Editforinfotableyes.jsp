...
<body>
	<form class="formtable" id="formtable">
  		...
  		<div class="form-group">
    		<label >车牌</label>
   			 <input name="car" value='<s:property value="car"/>' type="text" class="form-control" id="" placeholder="车牌">
  		</div>
  		<div class="form-group">
    		<label >司机</label>
   			 <input name="drivernum" value='<s:property value="drivernum"/>' type="text" class="form-control" id="" placeholder="司机">
  		</div>
  		<center>
  		<button type="button" class="btn btn-info subbtn" onclick="saveappliaction()">保存</button>
  		</center>
	</form>
	<script type="text/javascript" src="Main/js/Editforinfotableyes.js"></script>
</body>
</html>